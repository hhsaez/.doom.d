...
(when (display-graphic-p)
  ;; In TTY, ESC is the Meta prefix; keep it unmodified there.
...
* Markdown Editing
Make markdown buffers read more like Org by hiding markup and using variable
pitch while keeping code in fixed pitch.
...
(after! markdown-mode
  (setq markdown-fontify-code-blocks-natively t
        ...
        markdown-header-scaling-values '(1.7 1.4 1.25 1.12 1.06 1.0)
        markdown-hide-urls t)

  (defun hhsaez/markdown-setup ()
    "Make markdown buffers read like prose with hidden markup."
    (setq-local markdown-hide-markup t)
    (setq-local visual-fill-column-width 92
  ...
  (add-hook 'markdown-mode-hook #'hhsaez/markdown-setup)
  (add-hook 'gfm-mode-hook #'hhsaez/markdown-setup)
  ...
  (custom-set-faces!
    `(markdown-header-face-1 :weight bold :height 1.7 :foreground ,(doom-color 'orange))
    `(markdown-header-face-2 :weight bold :height 1.4 :foreground ,(doom-color 'yellow))
    `(markdown-header-face-3 :weight semi-bold :height 1.25 :foreground ,(doom-color 'green))
    `(markdown-header-face-4 :weight semi-bold :height 1.12 :foreground ,(doom-color 'blue))
    `(markdown-header-face-5 :weight semi-bold :height 1.06 :foreground ,(doom-color 'violet))
    `(markdown-header-face-6 :weight semi-bold :height 1.0 :foreground ,(doom-color 'cyan))
    `(markdown-pre-face :background "#1f2430" :extend t)
    `(markdown-code-face :background "#2a2f3a")
    `(markdown-inline-code-face :background "#2a2f3a" :box (:line-width 1 :color "#3a3f4b"))
    `(markdown-markup-face :inherit 'fixed-pitch :foreground ,(doom-color 'base5))
    `(markdown-language-keyword-face :inherit 'fixed-pitch :foreground ,(doom-color 'teal))
    `(markdown-blockquote-face :slant italic :foreground ,(doom-color 'base6)))
